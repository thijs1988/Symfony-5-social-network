...
class MessageController extends AbstractController
{
     ...
     * @return Response
     */
    public function index(Request $request, Conversation $conversation, SerializerInterface $serializer)
    {
        //can i view the conversation
        $this->denyAccessUnlessGranted('view', $conversation);
        $messages = $this->messageRepository->finMessageByConversationId(
          $conversation->getId()
        );
    ...
    public function newMessage(Request $request, Conversation $conversation, SerializerInterface $serializer)
    {
        ...
        $update = new Update(
            ...
            $messageSerialized,
            [
                sprintf("/index_conversation/%s", $recipient->getUser()->getUsername())
